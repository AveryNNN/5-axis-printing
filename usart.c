...
UART_HandleTypeDef UartHandle_485;
...
/**USART1 GPIO Configuration    
  ...
  */
  ...
  HAL_NVIC_SetPriority(SERIAL_USART_IRQ ,0,0);	//抢占优先级0，子优先级1
  HAL_NVIC_EnableIRQ(SERIAL_USART_IRQ );		    //使能USART1中断通道  
}
...
//		if(HAL_UART_Receive_IT(&UartHandle,(unsigned char *)recevie_char,HAL_RECEIVE_UART_SIZE) != HAL_OK)
//		{
